"""Bounded Hive-first research lookup and external-research decision (AX-364).

The service checks explicitly identified canonical knowledge through C2.09
before any external provider is considered. It performs no provider call.
Stale or contradictory evidence is visible and cannot masquerade as known.
"""
