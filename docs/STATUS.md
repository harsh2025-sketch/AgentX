...
Evidence snapshot: 2026-09-15. This ledger replaces the README's obsolete claim
...
- PR #157 repairs the formatting blocker on PR #156 in an isolated child branch.
- PR #158 adds the concrete HTTP model adapter. It is not a live-model benchmark.
...
| M8 Models/research | Canonical model/Reasoner and research contracts; #149 research candidate; #158 HTTP candidate | N2.07 L5; configured real service/credentials; plan-to-action wiring and live acceptance |
...
2. Finish the concrete provider gate and configure a real pinned model through
